...
biterr.obj: ../biterr.c $(GEN_OPTS) | $(GEN_HDRS)
	...
	"D:/anzhuanglujing/ccs/ccsv7/tools/compiler/c6000_7.4.24/bin/cl6x" -mv6740 --abi=eabi -O2 --include_path="D:/ccs_workspace/OFDM" --include_path="D:/anzhuanglujing/ccs/ccsv7/tools/compiler/c6000_7.4.24/include" --define=c6748 --diag_wrap=off --diag_warning=225 --display_error_number --preproc_with_compile --preproc_dependency="biterr.d_raw" $(GEN_OPTS__FLAG) "$<"
